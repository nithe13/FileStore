...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7547744538:AAEvuRytCvJI4SEZmBA3YPSQ2bqZdbSp8yI:")
#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "25508469"))
#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "9f12da65a8062bf30b83f229719ef993")
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002290971677"))
# NAMA OWNER
OWNER = os.environ.get("OWNER", "Nithe")
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1432496522"))
#Port
PORT = os.environ.get("PORT", "8030")
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://c66362048:qRgppfOHokWDa5Fo@cluster0.dgovf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1002073631817"))
#put 0 to disable
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002066904622"))#put 0 to disable
FORCE_SUB_CHANNEL3 = int(os.environ.get("FORCE_SUB_CHANNEL3", "-1002354531079"))#put 0 to disable
